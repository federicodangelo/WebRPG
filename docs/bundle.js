...
System.register("web/src/native/fonts", [], function (exports_14, context_14) {
  "use strict";
  ...
  exports_14("initFonts", initFonts);
  return {
    setters: [],
    execute: function () {
      exports_14("DEFAULT_FONT", DEFAULT_FONT = "font16x16");
      fonts = new Map([
        [
          "font16x16",
          {
...
System.register(
  "web/src/native/web",
  ["engine/src/types", "web/src/native/fonts", "web/src/native/tileset"],
